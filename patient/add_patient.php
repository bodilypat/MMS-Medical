...
<html lang="en">
    <head>
        <title>Patients | Add Patient</title>
        <!-- Custom CSS -->
            ...
            <div class="app-content">
                ...
                <div class="main-content">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                 <h1 class="mainTitle">Patients | Add Patients</h1>
                            </div>
                        </div>
                    </section>
                                    ...
                                    <div class="panel-body">
                                        <form role="form" name="patient-form" method="post">
                                            ...
                                            <div class="form-group">                                                
                                                ...
                                                <input type="text" id="firstName" name="firtName" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <!-- Medical History and Other Details -->
                                             <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="currentMedications" name="currentMedications" required>
                                            </div>

                                            <!-- Emergency Contact -->
                                            <div class="form-group">
                                                <label for="emergencyName">Emergency Contact Name</label>
                                                <inpuut type="text" id="emergencyName" name="emergencyName" requried>
                                            </div>
                                            <div class="form-group">
                                                <label for="emergencyRelation">Relationship</label>
                                                <input type="text" id="emergencyRelation" name="emergencyRelation" requried>
                                            </div>
                                            <div class="form-group">
                                                <label for="emergencyPhone">Emergency Contact Phone</label>
                                                <input type="tel" id="emergencyPhone" name="emargencyPhone" required>
                                            </div>
