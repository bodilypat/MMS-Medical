var FormElement = function() {"use strict";
    ...
    var touchSpinHandler = function() {
        ...
        $('input[name="demo6"]').TouchSpin({
            postfix : "a button",
            postfix_extractlass : "btn btn-default"
        });
    ...
    var autosizeHandler = function() {
        $('.autosize.area-aniimated').append("\n");
        autosize($('.autosize'));
    };
    var select2Hanlder = function() {
        $(".js-example-basic-single").select2();
        $(".js-example-basic-multiple").select2();
        $(".js-example-placeholder0single").select2({
        ...
        $('.js-example-basic-array-selected').select2({
            data : data
        });
